...
namespace Madphp\Src\Core\Event;

use Madphp\Src\Core\Support\Container;
...
class Dispatcher
{
	 ...
	 *
	 * @var \Madphp\Src\Core\Support\Container
	 */
	protected $container;
	 ...
	 *
	 * @param  \Madphp\Src\Core\Support\Container  $container
	 * @return void
	 */
	...
	public function listen($events, $listener, $priority = 0)
	{
		foreach ((array) $events as $event) {
			if (\Madphp\Src\Core\Support\Str::contains($event, '*')) {
	...
	protected function getWildcardListeners($eventName)
	{
		...
		foreach ($this->wildcards as $key => $listeners) {
			if (\Madphp\Src\Core\Support\Str::is($key, $eventName)) $wildcards = array_merge($wildcards, $listeners);
		}
